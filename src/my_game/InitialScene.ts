...
export class InitialScene extends BasicScene {
  ...
  private buildCorners() {
    ...
    this.gameObjects.push(GameObject.FromRenderable(leftUpCorner));
    ...
    this.gameObjects.push(GameObject.FromRenderable(rightUpCorner));
    ...
    this.gameObjects.push(GameObject.FromRenderable(rightDownCorner));
